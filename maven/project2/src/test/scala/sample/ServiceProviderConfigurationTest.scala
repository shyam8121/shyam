...
import sample.reader.mycomponent.MyStreamReaderImpl
import sample.transformer.mycomponent.MyStreamTransformerImpl
import sample.writer.mycomponent.MyStreamWriterImpl
